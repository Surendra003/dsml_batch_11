...
where division get the value in floating, modulus gets remainder after 
division like 20%7 is 6 because remainder is 6,
exponentiation is nothing but just the power of the input value like 2**2 is 4,
...
the floor of any number like 4.4 is 4, ceil() is 4.4=5,likewiwe math.gcd(),
...
we use different string operation like .upper(), lower, title, strip, 
replace, join
To replace two argument is use like text.replace("haha", "hello"),
Split simply split in the form of list like "haha hi" = ['haha', 'hi']
Join is like it joined after 1 word of each that we want to join
with like
'hello','surendra','khan' is "#".join(this_list)= hello#surendra#khan 
